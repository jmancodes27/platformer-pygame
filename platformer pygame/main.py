...
async def main():
    ...
    class Obstacle:
        def __init__(self, x, y, width, height):
            self.tile = pygame.image.load("grass.png").convert()
    ...
    class Flag:
        def __init__(self, x, y):
            self.flag = pygame.image.load("flag.png").convert()
    ...
    class AirElemental:
        def __init__(self, x, y, target_destination):
            air_elemental_idle_right1 = pygame.image.load("AirElementalIdle/air_idle_right0.png").convert()
            air_elemental_idle_right2 = pygame.image.load("AirElementalIdle/air_idle_right1.png").convert()
            air_elemental_idle_right3 = pygame.image.load("AirElementalIdle/air_idle_right2.png").convert()
            air_elemental_idle_right4 = pygame.image.load("AirElementalIdle/air_idle_right3.png").convert()
            air_elemental_idle_right5 = pygame.image.load("AirElementalIdle/air_idle_right4.png").convert()
            air_elemental_idle_right6 = pygame.image.load("AirElementalIdle/air_idle_right5.png").convert()
    ...
    print("finished loading gun and player")
    # All boss animations
    ...
    # player direction; see diagram above
      ...
      if last_time_comped != round(time.time(), 2):
          ...
          if x_velocity > 0:
              ...
              x_velocity += 0.1
           #fixes a bug that makes the player drift to the left
      ...
      for i in range(len(laser_projectiles)):
          if laser_projectiles[i].angle == 0:
              laser_projectiles[i].projectile_rect.y -= 20
          ...
          if laser_projectiles[i].angle == 2:
              laser_projectiles[i].projectile_rect.x += 20
